...
addNo(PhoneBook ph) //Function ke andar PhoneBook ka naya object (copy) ban raha h
{
	system("cls");
	...
	ofstream outfile("C:/Users/Anjali Maurya/Desktop/MY PROJECT/CPP_OOPS_PROJECTS/PhoneBook.txt",ios::app);
...
searchNo(){
	...
	ifstream infile("C:/Users/Anjali Maurya/Desktop/MY PROJECT/CPP_OOPS_PROJECTS/PhoneBook.txt");
	if(!infile){
